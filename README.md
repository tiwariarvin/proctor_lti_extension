...
Narrowing **`host_permissions`** in [`extension/manifest.json`](extension/manifest.json) to a single Brightspace host is a good **production** hardening step once you know the exact FQDN.
